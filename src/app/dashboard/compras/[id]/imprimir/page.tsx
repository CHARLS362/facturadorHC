...
export default function ImprimirCompraPage() {
  ...
  const renderContent = () => {
    ...
    if (!compra) {
      return (
        <Card className="w-full max-w-4xl mx-auto shadow-lg border-destructive/50">
          <CardHeader>
            <CardTitle className="text-destructive">Compra no encontrada</CardTitle>
            <CardDescription>No se pudo encontrar la compra con ID: {id}</CardDescription>
          </CardHeader>
          <CardContent>
  ...
  return (
    <div className="space-y-8 p-6 print:p-0">
      <div className="print-hide">
       ...
       <div id="printable-area-container" className="bg-muted flex justify-center py-8 print:p-0 print:bg-white">
        {renderContent()}
      </div>
    </div>
  );
